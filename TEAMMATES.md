...
| Nguyễn Hữu Nam (`nhut-nam`) | `2A202602981` | Retrieval, indexing và evaluation | `nam`; Task 4, 5, 6, 7, 9, 10; tạo golden dataset và script đánh giá | `1f75145`, `b400bcf`, `db75be5`; `group_project/evaluation/golden_dataset.json`; `evaluate.py` |
